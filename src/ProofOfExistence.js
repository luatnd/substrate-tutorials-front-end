...
export default function ProofOfExistence (props) {
  ...
  proofOfExistence is pallet_<proof_of_existence> was converted to camelcase by polkadot.js, I guess
   */
  return api.query.proofOfExistence && api.query.proofOfExistence.proofs ? (
    <Main {...props} />
  ) : null;
}
